...
mixin _$CreateGroupRequest {
 ...
 String get name; String get currency;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateGroupRequest&&(identical(other.name, name) || other.name == name)&&(identical(other.currency, currency) || other.currency == currency));
}
...
@override
String toString() {
  return 'CreateGroupRequest(name: $name, currency: $currency)';
}
...
/// Create a copy of CreateGroupRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? currency = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String currency)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateGroupRequest() when $default != null:
return $default(_that.name,_that.currency);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String currency)  $default,) {final _that = this;
switch (_that) {
case _CreateGroupRequest():
return $default(_that.name,_that.currency);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String currency)?  $default,) {final _that = this;
switch (_that) {
case _CreateGroupRequest() when $default != null:
return $default(_that.name,_that.currency);case _:
  return null;
...
class _CreateGroupRequest implements CreateGroupRequest {
  const _CreateGroupRequest({required this.name, required this.currency});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CreateGroupRequest&&(identical(other.name, name) || other.name == name)&&(identical(other.currency, currency) || other.currency == currency));
}
...
/// Create a copy of CreateGroupRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? currency = null,}) {
